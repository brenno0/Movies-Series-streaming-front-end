      ...
      >
        ...
        <div
          className={cn(
            ...
            !isRecommendationPanel && hovered === index
              ? 'opacity-100'
              : 'opacity-0',
        ...
        >
          {isRecommendationPanel && (
            <div className="relative h-full top-20 left-10">
              ...
              <Button
                variant="default"
                size="lg"
                className="h-12 w-70 mt-10 bg-primary text-white hover:bg-blue-800 cursor-pointer"
              >
                <PlayCircle />
                Assistir
              </Button>
              <Button
                variant="outline"
                size="lg"
                className="ml-10 h-12 w-70 mt-10 font-bold text-white  bg-transparent border-white hover:border-white/70 hover:text-white/70 hover:bg-transparent cursor-pointer"
              >
                <Bookmark />
                Adicionar a Lista
              </Button>
          ...
          <div className="w-full flex items-center mt-2 gap-1">
            ...
            <p className="text-blue-300 font-bold">
              {card.category === 'movie' ? 'Filme' : 'Série'}
            </p>
          </div>
        </div>
      </div>
